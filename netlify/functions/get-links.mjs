// netlify/functions/get-links.mjs â€” polled while the link plan builds.
...
export default async (req) => {
  ...
  try {
    ...
    const { data } = await supabase.from("content_briefs").select("links_plan,links_status").eq("id", id).single();

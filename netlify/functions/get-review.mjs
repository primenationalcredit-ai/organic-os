// netlify/functions/get-review.mjs â€” polled while the AI review runs.
...
export default async (req) => {
  ...
  try {
    ...
    const { data } = await supabase.from("content_briefs").select("ai_status,ai_review,status,review_note").eq("id", id).single();

// netlify/functions/get-serp-brief.mjs â€” polled while the SERP blueprint builds.
...
export default async (req) => {
  ...
  try {
    ...
    const { data } = await supabase.from("content_briefs").select("serp_brief,serp_status").eq("id", id).single();
